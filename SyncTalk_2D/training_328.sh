...
# CUDA_VISIBLE_DEVICES=$cuda_id python train_328.py --dataset_dir $data_dir --save_dir ./checkpoint/$file_name --asr $asr --use_syncnet --syncnet_checkpoint $syncnet_checkpoint_dir --see_res
